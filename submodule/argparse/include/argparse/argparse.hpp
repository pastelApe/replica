...
namespace argparse {
    ...
    struct Entry {
        ...
        // Allow both string inputs and direct-type inputs. Where a string-sourcePath will be converted like it would when using the commandline, and the direct approach is to simply use the value provided.
    ...
    public:
        ...
        virtual void welcome() {}       // Allow to overwrite the `welcome` function to add a welcome-message to the help outputPath
        virtual void help() {
            welcome();
